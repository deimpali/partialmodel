...
/**
 * This is the item provider adapter for a {@link partialmodel.VarType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarTypeItemProvider extends PSTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VarType_Annotation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VarType_Annotation_feature", "_UI_VarType_type"),
				 PartialmodelPackage.Literals.VAR_TYPE__ANNOTATION,
				 true,
				 false,
				 false,
